...
INSERT INTO optional_holidays (date, name, description) VALUES
    ('2024-01-01', 'New Year''s Day', 'First day of the year'),
    ('2024-07-04', 'Independence Day', 'United States Independence Day'),
    ('2024-05-27', 'Memorial Day', 'Memorial Day holiday'),
    ('2024-11-28', 'Thanksgiving Day', 'Thanksgiving Day'),
    ('2024-12-25', 'Christmas Day', 'Christmas Day celebration'),
    ('2024-09-02', 'Labor Day', 'Labor Day holiday'),
    ('2024-11-11', 'Veterans Day', 'Veterans Day observance');
